...
gst_object_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstObjectFlags", values);
  }
  return etype;
}
...
gst_bin_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstBinFlags", values);
  }
  return etype;
}
...
gst_bus_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstBusFlags", values);
  }
  return etype;
}
...
gst_element_flags_get_type (void)
{
  ...
  if (etype == 0) {
    static const GFlagsValue values[] = {
      ...
      {GST_ELEMENT_CHANGING_STATE, "GST_ELEMENT_CHANGING_STATE",
            "changing-state"},
      {GST_ELEMENT_FLAG_LAST, "GST_ELEMENT_FLAG_LAST", "flag-last"},
      {0, NULL, NULL}
    };
    etype = g_flags_register_static ("GstElementFlags", values);
  }
  return etype;
}
...
gst_index_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstIndexFlags", values);
  }
  return etype;
}
...
gst_pad_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstPadFlags", values);
  }
  return etype;
}
...
gst_pad_template_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstPadTemplateFlags", values);
  }
  return etype;
}
...
gst_pipeline_flags_get_type (void)
{
  ...
  if (etype == 0) {
    ...
    etype = g_flags_register_static ("GstPipelineFlags", values);
  }
  return etype;
}
