...
# ADD CPP /nologo /MD /W3 /O2 /I "../.." /I "../common" /I "../../gst-libs" /I "../../../gstreamer/win32" /I "../../../gstreamer" /I "../../gst-libs/gst/audio" /I "../../../gstreamer/win32/common" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "LIBGSTVIDEO_EXPORTS" /D "HAVE_CONFIG_H" /YX /FD /c
...
# ADD LINK32 libgstreamer-0.9.lib libgstbase-0.9.lib glib-2.0.lib gobject-2.0.lib /nologo /dll /machine:I386 /out:"Release/libgstvideo-0.9.dll" /libpath:"../../../gstreamer/win32/vs6/release" /libpath:"./release"
# Begin Special Build Tool
TargetPath=.\Release\libgstvideo-0.9.dll
SOURCE="$(InputPath)"
...
# ADD CPP /nologo /MDd /W3 /Gm /ZI /Od /I "../../../gstreamer/win32/common" /I "../../gst-libs" /I "../../../gstreamer/win32" /I "../../../gstreamer" /I "../../gst-libs/gst/audio" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "LIBGSTVIDEO_EXPORTS" /D "HAVE_CONFIG_H" /YX /FD /GZ /c
...
# ADD LINK32 libgstreamer-0.9.lib libgstbase-0.9.lib glib-2.0.lib gobject-2.0.lib /nologo /dll /debug /machine:I386 /out:"Debug/libgstvideo-0.9.dll" /pdbtype:sept /libpath:"../../../gstreamer/win32/vs6/debug" /libpath:"./debug"
# Begin Special Build Tool
TargetPath=.\Debug\libgstvideo-0.9.dll
SOURCE="$(InputPath)"
PostBuild_Cmds=copy /Y $(TargetPath) c:\gstreamer\bin
# End Special Build Tool
