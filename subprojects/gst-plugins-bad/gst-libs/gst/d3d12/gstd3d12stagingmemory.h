...
#define GST_D3D12_STAGING_ALLOCATOR(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_D3D12_STAGING_ALLOCATOR, GstD3D12StagingAllocator))
#define GST_D3D12_STAGING_ALLOCATOR_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_D3D12_STAGING_ALLOCATOR, GstD3D12StagingAllocatorClass))
...
#define GST_D3D12_STAGING_ALLOCATOR_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_D3D12_STAGING_ALLOCATOR, GstD3D12StagingAllocatorClass))
#define GST_D3D12_STAGING_ALLOCATOR_CAST(obj)       ((GstD3D12StagingAllocator *)obj)
