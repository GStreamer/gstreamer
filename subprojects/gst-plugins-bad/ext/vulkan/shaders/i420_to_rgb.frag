...
layout(set = 0, binding = 3) uniform sampler2D inTexture2;

layout(location = 0) out vec4 outColor0;

void main()
{
  vec3 yuv = upsample_I420(inTexture0, inTexture1, inTexture2, inTexCoord, in_reorder_idx);
  vec4 rgba = vec4(1.0);
