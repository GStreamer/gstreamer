...
#region Autogenerated code
	public partial class Timeline : Gst.Bin, GES.IExtractable, GES.IMetaContainer {
		...
		[DllImport("ges-1.0", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr ges_timeline_get_groups_full(IntPtr raw);

		public GES.Group[] GroupsFull { 
			get {
				IntPtr raw_ret = ges_timeline_get_groups_full(Handle);
				GES.Group[] ret = (GES.Group[]) GLib.Marshaller.ListPtrToArray (raw_ret, typeof(GLib.List), true, true, typeof(GES.Group));
				return ret;
			}
		}
		...
		[DllImport("ges-1.0", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr ges_timeline_get_track_for_pad_full(IntPtr raw, IntPtr pad);

		public GES.Track GetTrackForPadFull(Gst.Pad pad) {
			IntPtr raw_ret = ges_timeline_get_track_for_pad_full(Handle, pad == null ? IntPtr.Zero : pad.Handle);
