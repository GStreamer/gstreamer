...
#region Autogenerated code
	public partial class VideoEncoder : Gst.Element, Gst.IPreset {
		...
		[GLib.DefaultSignalHandler(Type=typeof(Gst.Video.VideoEncoder), ConnectionMethod="OverridePrepareAllocator")]
		...
		[DllImport("gstvideo-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gst_video_encoder_set_allocator(IntPtr raw, IntPtr allocator, IntPtr parms);
		...
		public void SetAllocator(Gst.Allocator allocator, Gst.AllocationParams parms) {
			...
			gst_video_encoder_set_allocator(Handle, allocator == null ? IntPtr.Zero : allocator.OwnedHandle, native_parms);
			Marshal.FreeHGlobal (native_parms);
		}
