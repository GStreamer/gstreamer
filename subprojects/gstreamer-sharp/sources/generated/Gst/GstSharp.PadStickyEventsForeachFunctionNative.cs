...
#region Autogenerated code
	...
	internal delegate bool PadStickyEventsForeachFunctionNative(IntPtr pad, ref IntPtr evnt, IntPtr user_data);
	...
	internal class PadStickyEventsForeachFunctionInvoker {
		...
		bool InvokeNative (Gst.Pad pad, ref Gst.Event evnt)
		{
			IntPtr native_evnt = evnt == null ? IntPtr.Zero : evnt.Handle ;
			bool __result = native_cb (pad == null ? IntPtr.Zero : pad.Handle, ref native_evnt, __data);
	...
	internal class PadStickyEventsForeachFunctionWrapper {
		...
		public bool NativeCallback (IntPtr pad, ref IntPtr evnt, IntPtr user_data)
		{
			try {
				Gst.Event myevnt = evnt == IntPtr.Zero ? null : (Gst.Event) GLib.Opaque.GetOpaque (evnt, typeof (Gst.Event), true);

				bool __ret = managed (GLib.Object.GetObject(pad) as Gst.Pad, ref myevnt);
				evnt = myevnt == null ? IntPtr.Zero : myevnt.Handle;
