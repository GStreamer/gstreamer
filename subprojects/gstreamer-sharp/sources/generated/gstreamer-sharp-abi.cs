...
namespace AbiTester {
	class ___Gst {
		public static void Main (string[] args) {
			...
			Console.WriteLine("\"GstAppSinkClass.try_pull_object\": \"" + Gst.App.AppSink.class_abi.GetFieldOffset("try_pull_object") + "\"");
			...
			Console.WriteLine("\"GstDiscovererClass.load_serialize_info\": \"" + Gst.PbUtils.Discoverer.class_abi.GetFieldOffset("load_serialize_info") + "\"");
			...
			Console.WriteLine("\"sizeof(GstRTPHeaderExtensionClass)\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.Size + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.get_supported_flags\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("get_supported_flags") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.get_max_size\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("get_max_size") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.write\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("write") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.read\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("read") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.set_non_rtp_sink_caps\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("set_non_rtp_sink_caps") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.update_non_rtp_src_caps\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("update_non_rtp_src_caps") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.set_attributes\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("set_attributes") + "\"");
			Console.WriteLine("\"GstRTPHeaderExtensionClass.set_caps_from_attributes\": \"" + Gst.Rtp.RTPHeaderExtension.class_abi.GetFieldOffset("set_caps_from_attributes") + "\"");
			Console.WriteLine("\"sizeof(GstRTPHeaderExtension)\": \"" + Gst.Rtp.RTPHeaderExtension.abi_info.Size + "\"");
			...
			Console.WriteLine("\"GstVideoAggregatorPadClass.prepare_frame_start\": \"" + Gst.Video.VideoAggregatorPad.class_abi.GetFieldOffset("prepare_frame_start") + "\"");
			Console.WriteLine("\"GstVideoAggregatorPadClass.prepare_frame_finish\": \"" + Gst.Video.VideoAggregatorPad.class_abi.GetFieldOffset("prepare_frame_finish") + "\"");
			...
			Console.WriteLine("\"sizeof(GstVideoAggregatorParallelConvertPadClass)\": \"" + Gst.Video.VideoAggregatorParallelConvertPad.class_abi.Size + "\"");
			...
			Console.WriteLine("\"GstVideoDecoderClass.handle_missing_data\": \"" + Gst.Video.VideoDecoder.class_abi.GetFieldOffset("handle_missing_data") + "\"");
			...
			Console.WriteLine("\"GstVideoSinkClass.set_info\": \"" + Gst.Video.VideoSink.class_abi.GetFieldOffset("set_info") + "\"");
			...
			Console.WriteLine("\"sizeof(GstWebRTCICEClass)\": \"" + Gst.WebRTC.WebRTCICE.class_abi.Size + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.add_stream\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("add_stream") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.find_transport\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("find_transport") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.gather_candidates\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("gather_candidates") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.add_candidate\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("add_candidate") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_local_credentials\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_local_credentials") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_remote_credentials\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_remote_credentials") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.add_turn_server\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("add_turn_server") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_is_controller\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_is_controller") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.get_is_controller\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("get_is_controller") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_force_relay\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_force_relay") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_stun_server\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_stun_server") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.get_stun_server\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("get_stun_server") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_turn_server\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_turn_server") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.get_turn_server\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("get_turn_server") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_http_proxy\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_http_proxy") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.get_http_proxy\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("get_http_proxy") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_tos\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_tos") + "\"");
			Console.WriteLine("\"GstWebRTCICEClass.set_on_ice_candidate\": \"" + Gst.WebRTC.WebRTCICE.class_abi.GetFieldOffset("set_on_ice_candidate") + "\"");
			...
			Console.WriteLine("\"GstWebRTCICE.min_rtp_port\": \"" + Gst.WebRTC.WebRTCICE.abi_info.GetFieldOffset("min_rtp_port") + "\"");
			Console.WriteLine("\"GstWebRTCICE.max_rtp_port\": \"" + Gst.WebRTC.WebRTCICE.abi_info.GetFieldOffset("max_rtp_port") + "\"");
			Console.WriteLine("\"sizeof(GstWebRTCICEStreamClass)\": \"" + Gst.WebRTC.WebRTCICEStream.class_abi.Size + "\"");
			Console.WriteLine("\"GstWebRTCICEStreamClass.find_transport\": \"" + Gst.WebRTC.WebRTCICEStream.class_abi.GetFieldOffset("find_transport") + "\"");
			Console.WriteLine("\"GstWebRTCICEStreamClass.gather_candidates\": \"" + Gst.WebRTC.WebRTCICEStream.class_abi.GetFieldOffset("gather_candidates") + "\"");
			Console.WriteLine("\"sizeof(GstWebRTCICEStream)\": \"" + Gst.WebRTC.WebRTCICEStream.abi_info.Size + "\"");
