...
int main (int argc, char *argv[]) {
	...
	g_print("\"GstAppSinkClass.try_pull_object\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstAppSinkClass, try_pull_object));
	...
	g_print("\"GstDiscovererClass.load_serialize_info\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstDiscovererClass, load_serialize_info));
	...
	g_print("\"sizeof(GstRTPHeaderExtensionClass)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstRTPHeaderExtensionClass));
	g_print("\"GstRTPHeaderExtensionClass.get_supported_flags\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, get_supported_flags));
	g_print("\"GstRTPHeaderExtensionClass.get_max_size\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, get_max_size));
	g_print("\"GstRTPHeaderExtensionClass.write\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, write));
	g_print("\"GstRTPHeaderExtensionClass.read\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, read));
	g_print("\"GstRTPHeaderExtensionClass.set_non_rtp_sink_caps\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, set_non_rtp_sink_caps));
	g_print("\"GstRTPHeaderExtensionClass.update_non_rtp_src_caps\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, update_non_rtp_src_caps));
	g_print("\"GstRTPHeaderExtensionClass.set_attributes\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, set_attributes));
	g_print("\"GstRTPHeaderExtensionClass.set_caps_from_attributes\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstRTPHeaderExtensionClass, set_caps_from_attributes));
	g_print("\"sizeof(GstRTPHeaderExtension)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstRTPHeaderExtension));
	...
	g_print("\"GstVideoAggregatorPadClass.prepare_frame_start\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstVideoAggregatorPadClass, prepare_frame_start));
	g_print("\"GstVideoAggregatorPadClass.prepare_frame_finish\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstVideoAggregatorPadClass, prepare_frame_finish));
	...
	g_print("\"sizeof(GstVideoAggregatorParallelConvertPadClass)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstVideoAggregatorParallelConvertPadClass));
	...
	g_print("\"GstVideoDecoderClass.handle_missing_data\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstVideoDecoderClass, handle_missing_data));
	...
	g_print("\"GstVideoSinkClass.set_info\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstVideoSinkClass, set_info));
	...
	g_print("\"sizeof(GstWebRTCICEClass)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstWebRTCICEClass));
	g_print("\"GstWebRTCICEClass.add_stream\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, add_stream));
	g_print("\"GstWebRTCICEClass.find_transport\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, find_transport));
	g_print("\"GstWebRTCICEClass.gather_candidates\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, gather_candidates));
	g_print("\"GstWebRTCICEClass.add_candidate\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, add_candidate));
	g_print("\"GstWebRTCICEClass.set_local_credentials\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_local_credentials));
	g_print("\"GstWebRTCICEClass.set_remote_credentials\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_remote_credentials));
	g_print("\"GstWebRTCICEClass.add_turn_server\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, add_turn_server));
	g_print("\"GstWebRTCICEClass.set_is_controller\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_is_controller));
	g_print("\"GstWebRTCICEClass.get_is_controller\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, get_is_controller));
	g_print("\"GstWebRTCICEClass.set_force_relay\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_force_relay));
	g_print("\"GstWebRTCICEClass.set_stun_server\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_stun_server));
	g_print("\"GstWebRTCICEClass.get_stun_server\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, get_stun_server));
	g_print("\"GstWebRTCICEClass.set_turn_server\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_turn_server));
	g_print("\"GstWebRTCICEClass.get_turn_server\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, get_turn_server));
	g_print("\"GstWebRTCICEClass.set_http_proxy\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_http_proxy));
	g_print("\"GstWebRTCICEClass.get_http_proxy\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, get_http_proxy));
	g_print("\"GstWebRTCICEClass.set_tos\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_tos));
	g_print("\"GstWebRTCICEClass.set_on_ice_candidate\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEClass, set_on_ice_candidate));
	...
	g_print("\"GstWebRTCICE.min_rtp_port\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICE, min_rtp_port));
	g_print("\"GstWebRTCICE.max_rtp_port\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICE, max_rtp_port));
	g_print("\"sizeof(GstWebRTCICEStreamClass)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstWebRTCICEStreamClass));
	g_print("\"GstWebRTCICEStreamClass.find_transport\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEStreamClass, find_transport));
	g_print("\"GstWebRTCICEStreamClass.gather_candidates\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) G_STRUCT_OFFSET(GstWebRTCICEStreamClass, gather_candidates));
	g_print("\"sizeof(GstWebRTCICEStream)\": \"%" G_GUINT64_FORMAT "\"\n", (guint64) sizeof(GstWebRTCICEStream));
