 ...
 * @GST_VIDEO_FORMAT_ARGB_F32: packed RGB with alpha channel first, 32-bit (native endianness) floating point per channel (A-R-G-B) (Since: 1.30)
 * @GST_VIDEO_FORMAT_RGBP_F16LE: planar 4:4:4 RGB, 16-bit floating point per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_RGBP_F16BE: planar 4:4:4 RGB, 16-bit floating point per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_RGBP_F32LE: planar 4:4:4 RGB, 32-bit floating point per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_RGBP_F32BE: planar 4:4:4 RGB, 32-bit floating point per channel (Since: 1.30)
 * @GST_VIDEO_FORMAT_RGB_F16LE: packed 4:4:4 RGB, 16-bit floating point per channel (Since: 1.30)
...
typedef enum {
  ...
  /**
   * GST_VIDEO_FORMAT_ARGB_F32:
   *
   * packed RGB with alpha channel first, 32-bit floating point
   * per channel (A-R-G-B), native endian.
  ...
  /**
   * GST_VIDEO_FORMAT_RGBP_F16LE:
   *
   * planar 4:4:4 RGB, 16-bit floating point per channel little endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGBP_F16BE:
   *
   * planar 4:4:4 RGB, 16-bit floating point per channel big endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGBP_F32LE:
   *
   * planar 4:4:4 RGB, 32-bit floating point per channel little endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGBP_F32BE:
   *
   * planar 4:4:4 RGB, 32-bit floating point per channel big endian
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGB_F16LE:
   *
   * packed 4:4:4 RGB, 16-bit floating point per channel little endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGB_F16BE:
   *
   * packed 4:4:4 RGB, 16-bit floating point per channel big endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
  ...
  /**
   * GST_VIDEO_FORMAT_RGB_F32LE:
   *
   * packed 4:4:4 RGB, 32-bit floating point per channel little endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
   ...
   *
   * packed 4:4:4 RGB, 32-bit floating point per channel big endian.
   * See %GST_VIDEO_FORMAT_FLAG_FLOAT for the component value conventions.
   *
   * Since: 1.30
   */
...
#define GST_VIDEO_FORMATS_ALL_STR "RGBA_F32BE, AYUV_F32, RGBA_F32LE, ARGB_F32, " \
    ...
    "A420_12BE, A420_12LE, RGBA_F16BE, RGBA_F16LE, A444_10BE, GBRA_10BE, " \
    ...
    "ABGR, A422, A420, AV12, RGBP_F32BE, RGBP_F32LE, RGB_F32BE, RGB_F32LE, " \
    "Y444_16BE, GBR_16BE, Y444_16LE, GBR_16LE, Y216_BE, v216, Y216_LE, " \
    "P016_BE, P016_LE, Y444_12BE, GBR_12BE, Y444_12LE, GBR_12LE, I422_12BE, " \
    "I422_12LE, Y212_BE, Y212_LE, I420_12BE, I420_12LE, P012_BE, P012_LE, " \
    "RGBP_F16BE, RGBP_F16LE, RGB_F16BE, RGB_F16LE, Y444_10BE, GBR_10BE, " \
    "Y444_10LE, GBR_10LE, r210, BGR10x2_LE, RGB10x2_LE, I422_10BE, I422_10LE, " \
    "NV16_10LE40, NV16_10LE32, Y210, UYVP, v210, I420_10BE, I420_10LE, " \
    "P010_10BE, MT2110R, MT2110T, NV12_10BE_8L128, NV12_10LE40_4L4, P010_10LE, " \
    "NV12_10LE40, NV12_10LE32, Y444, BGRP, GBR, RGBP, NV24, v308, IYU2, RGBx, " \
...
#define GST_VIDEO_FORMATS_ALL_STR "AYUV_F32, RGBA_F32LE, ARGB_F32, RGBA_F32BE, " \
    ...
    "A420_12LE, A420_12BE, RGBA_F16LE, RGBA_F16BE, A444_10LE, GBRA_10LE, " \
    "A444_10BE, GBRA_10BE, A422_10LE, A422_10BE, A420_10LE, A420_10BE, " \
    "BGR10A2_LE, RGB10A2_LE, Y410, A444, GBRA, AYUV, VUYA, RGBA, RBGA, ARGB, " \
    "BGRA, ABGR, A422, A420, AV12, RGBP_F32LE, RGBP_F32BE, RGB_F32LE, " \
    "RGB_F32BE, Y444_16LE, GBR_16LE, Y444_16BE, GBR_16BE, Y216_LE, Y216_BE, " \
    "v216, P016_LE, P016_BE, Y444_12LE, GBR_12LE, Y444_12BE, GBR_12BE, " \
    "I422_12LE, I422_12BE, Y212_LE, Y212_BE, I420_12LE, I420_12BE, P012_LE, " \
    "P012_BE, RGBP_F16LE, RGBP_F16BE, RGB_F16LE, RGB_F16BE, Y444_10LE, " \
    "GBR_10LE, Y444_10BE, GBR_10BE, BGR10x2_LE, RGB10x2_LE, r210, I422_10LE, " \
    "I422_10BE, NV16_10LE40, NV16_10LE32, Y210, UYVP, v210, I420_10LE, " \
