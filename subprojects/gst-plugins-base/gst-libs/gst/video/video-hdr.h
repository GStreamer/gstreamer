 ...
 * @bezier_curve_anchors: the i-th intermediate anchor parameter of the tone
 * mapping function in the w-th processing window in the scene
 * @color_saturation_mapping_flag: shall be equal to zero in this version of the standard.
 * @color_saturation_weight: a number that shall adjust the color saturation gain
 * in the w-th processing window in the scene
 *
