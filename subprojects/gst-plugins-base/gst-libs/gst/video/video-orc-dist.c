...
void video_orc_unpack_RGBA_F32 (guint16 * ORC_RESTRICT d1,
    const gfloat * ORC_RESTRICT s1, int n);
void video_orc_unpack_RGBA_F32_swap (guint16 * ORC_RESTRICT d1,
    const gfloat * ORC_RESTRICT s1, int n);
void video_orc_pack_RGBA_F32 (gfloat * ORC_RESTRICT d1,
    const guint16 * ORC_RESTRICT s1, int n);
void video_orc_pack_RGBA_F32_swap (gfloat * ORC_RESTRICT d1,
    const guint16 * ORC_RESTRICT s1, int n);
    ...
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  /* 3: loadpb */
  var36 = 0xff;                 /* 255 or 1.25987e-321f */
    ...
    int n)
{
  ...
  /* 2: loadpb */
  var37.x2[0] = 0x00ff;         /* 255 or 1.25987e-321f */
  var37.x2[1] = 0x00ff;         /* 255 or 1.25987e-321f */
    ...
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  /* 4: loadpb */
  var37.x2[0] = 0xff;           /* 255 or 1.25987e-321f */
  var37.x2[1] = 0xff;           /* 255 or 1.25987e-321f */
    ...
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  /* 3: loadpb */
  var38.x2[0] = 0xff;           /* 255 or 1.25987e-321f */
  var38.x2[1] = 0xff;           /* 255 or 1.25987e-321f */
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  /* 0: loadpb */
  var33 = 0xff;                 /* 255 or 1.25987e-321f */
  /* 3: loadpw */
  var35.i = 0x8080;             /* 32896 or 1.62528e-319f */
    ...
    const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  /* 3: loadpb */
  var36.x2[0] = 0xff;           /* 255 or 1.25987e-321f */
  var36.x2[1] = 0xff;           /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var38.i = 0x7c00;             /* 31744 or 1.56836e-319f */
  /* 3: loadpw */
  var39.i = 0x03e0;             /* 992 or 4.90113e-321f */
  /* 5: loadpw */
  var40.i = 0x001f;             /* 31 or 1.5316e-322f */
  /* 8: loadpw */
  var41.i = 0x0210;             /* 528 or 2.60867e-321f */
  /* 10: loadpw */
  var42.i = 0x4200;             /* 16896 or 8.34773e-320f */
  /* 13: loadpw */
  var43.i = 0x00ff;             /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  var40.i = 0x001f;             /* 31 or 1.5316e-322f */
  /* 10: loadpw */
  var41.i = 0x00ff;             /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var39.i = 0xf800;             /* 63488 or 3.13672e-319f */
  /* 3: loadpw */
  var40.i = 0x07e0;             /* 2016 or 9.96036e-321f */
  /* 5: loadpw */
  var41.i = 0x001f;             /* 31 or 1.5316e-322f */
  /* 9: loadpw */
  var42.i = 0x4200;             /* 16896 or 8.34773e-320f */
  /* 11: loadpw */
  var43.i = 0x2080;             /* 8320 or 4.11063e-320f */
  /* 14: loadpw */
  var44.i = 0x00ff;             /* 255 or 1.25987e-321f */
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  var41.i = 0x001f;             /* 31 or 1.5316e-322f */
  /* 10: loadpw */
  var42.i = 0x00ff;             /* 255 or 1.25987e-321f */
    ...
    int p1, int n)
{
  ...
  var38.i = p1;
  /* 8: loadpw */
  var39.i = 0x0080;             /* 128 or 6.32404e-322f */
    ...
    int p4, int p5, int n, int m)
{
  ...
  for (j = 0; j < m; j++) {
    ...
    /* 1: loadpb */
    var47.x4[0] = 0x80;         /* 128 or 6.32404e-322f */
    var47.x4[1] = 0x80;         /* 128 or 6.32404e-322f */
    var47.x4[2] = 0x80;         /* 128 or 6.32404e-322f */
    var47.x4[3] = 0x80;         /* 128 or 6.32404e-322f */
    /* 9: loadpw */
    var48.i = p1;
    /* 11: loadpw */
    var49.i = p2;
    ...
    int n)
{
  ...
  /* 1: loadpb */
  var43 = 0x80;                 /* 128 or 6.32404e-322f */
  /* 10: loadpw */
  var44.i = p1;
  /* 12: loadpw */
  var45.i = p2;
  /* 16: loadpb */
  var46 = 0x7f;                 /* 127 or 6.27463e-322f */
  /* 18: loadpw */
  var47.i = p3;
  /* 22: loadpw */
  var48.i = p4;
    ...
    int p2, int p3, int p4, int p5, int n)
{
  ...
  /* 1: loadpb */
  var44 = 0x80;                 /* 128 or 6.32404e-322f */
  /* 12: loadpw */
  var46.i = p1;
  /* 14: loadpw */
  var47.i = p2;
  ...
  var50.i = p5;
  /* 32: loadpb */
  var51.x4[0] = 0x80;           /* 128 or 6.32404e-322f */
  var51.x4[1] = 0x80;           /* 128 or 6.32404e-322f */
  var51.x4[2] = 0x80;           /* 128 or 6.32404e-322f */
  var51.x4[3] = 0x80;           /* 128 or 6.32404e-322f */
    ...
    const gint16 * ORC_RESTRICT s3, const gint16 * ORC_RESTRICT s4, int n)
{
  ...
  /* 9: loadpw */
  var38.i = 0x0020;             /* 32 or 1.58101e-322f */
    ...
    int n)
{
  ...
  var37.i = p1;
  /* 7: loadpw */
  var38.i = 0x0080;             /* 128 or 6.32404e-322f */
    ...
    int p2, int p3, int p4, int n)
{
  ...
  var41.i = p4;
  /* 19: loadpw */
  var42.i = 0x0020;             /* 32 or 1.58101e-322f */
    ...
    const gint16 * ORC_RESTRICT s7, int n)
{
  ...
  /* 16: loadpw */
  var41.i = 0x0020;             /* 32 or 1.58101e-322f */
    ...
    const gint16 * ORC_RESTRICT s1, int n)
{
  ...
  /* 1: loadpw */
  var34.i = 0x0020;             /* 32 or 1.58101e-322f */
    ...
    const gint16 * ORC_RESTRICT s5, int p1, int p2, int p3, int p4, int n)
{
  ...
  var41.i = p4;
  /* 21: loadpw */
  var43.i = 0x0020;             /* 32 or 1.58101e-322f */
    ...
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  /* 6: loadpw */
  var41.x2[0] = 0x0003;         /* 3 or 1.4822e-323f */
  var41.x2[1] = 0x0003;         /* 3 or 1.4822e-323f */
  /* 9: loadpw */
  var42.x2[0] = 0x0002;         /* 2 or 9.88131e-324f */
  var42.x2[1] = 0x0002;         /* 2 or 9.88131e-324f */
    ...
    const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  /* 17: loadpw */
  var41.x2[0] = 0x0004;         /* 4 or 1.97626e-323f */
  var41.x2[1] = 0x0004;         /* 4 or 1.97626e-323f */
...
video_orc_dither_fs_muladd_u8 (guint16 * ORC_RESTRICT d1, int n)
{
  ...
  /* 1: loadpw */
  var34.i = 0x0005;             /* 5 or 2.47033e-323f */
  /* 6: loadpw */
  var36.i = 0x0003;             /* 3 or 1.4822e-323f */
...
/* video_orc_unpack_RGBA_F32 */
#ifdef DISABLE_ORC
void
video_orc_unpack_RGBA_F32 (guint16 * ORC_RESTRICT d1,
    const gfloat * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union16 *ORC_RESTRICT ptr0;
  ...
  /* 5: loadpl */
  var35.i = 0x3f800000;         /* 1065353216 or 5.26354e-315f */
  /* 7: loadpl */
  var36.i = 0x477fff00;         /* 1199570688 or 5.92667e-315f */
  /* 9: loadpl */
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 4: maxf */
    {
      ...
      if (ORC_ISNAN (_src1.i))
        ...
        var42.i = (_src1.f > _src2.f) ? _src1.i : _src2.i;
    }
    /* 6: minf */
    {
      orc_union32 _src1;
      ...
      if (ORC_ISNAN (_src1.i))
        ...
        var43.i = (_src1.f < _src2.f) ? _src1.i : _src2.i;
    }
    /* 8: mulf */
    {
      orc_union32 _src1;
    ...
    /* 11: convfl */
    {
      int tmp;
      tmp = (int) var45.f;
      if (tmp == 0x80000000 && !(var45.i & 0x80000000))
        tmp = 0x7fffffff;
      var46.i = tmp;
    }
    /* 12: convlw */
...
#else
static void
_backup_video_orc_unpack_RGBA_F32 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union16 *ORC_RESTRICT ptr0;
    ...
    const gfloat * ORC_RESTRICT s1, int n)
{
  ...
  if (!orc_once_enter (&once, (void **) &c)) {
    ...
    static const orc_uint8 bc[] = {
      1, 9, 25, 118, 105, 100, 101, 111, 95, 111, 114, 99, 95, 117, 110, 112,
      97, 99, 107, 95, 82, 71, 66, 65, 95, 70, 51, 50, 11, 2, 2, 12,
      4, 4, 14, 4, 0, 0, 0, 0, 14, 4, 0, 0, 128, 63, 14, 4,
      0, 255, 127, 71, 14, 4, 0, 0, 0, 63, 20, 4, 20, 4, 113, 32,
      4, 207, 33, 32, 32, 106, 32, 32, 33, 205, 32, 32, 16, 206, 32, 32,
      17, 202, 32, 32, 18, 200, 32, 32, 19, 210, 33, 32, 163, 0, 33, 2,
      0,
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_orc_unpack_RGBA_F32);
#else
    p = orc_program_new ();
    orc_program_set_name (p, "video_orc_unpack_RGBA_F32");
    orc_program_set_backup_function (p, _backup_video_orc_unpack_RGBA_F32);
    orc_program_add_destination (p, 2, "d1");
    orc_program_add_source (p, 4, "s1");
    orc_program_add_constant (p, 4, 0x00000000, "c1");
    orc_program_add_constant (p, 4, 0x3f800000, "c2");
    orc_program_add_constant (p, 4, 0x477fff00, "c3");
    orc_program_add_constant (p, 4, 0x3f000000, "c4");
    orc_program_add_temporary (p, 4, "t1");
    orc_program_add_temporary (p, 4, "t2");

    orc_program_append_2 (p, "loadl", 0, ORC_VAR_T1, ORC_VAR_S1, ORC_VAR_D1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "cmpeqf", 0, ORC_VAR_T2, ORC_VAR_T1, ORC_VAR_T1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "andl", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_T2,
        ORC_VAR_D1);
    orc_program_append_2 (p, "maxf", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_C1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "minf", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_C2,
        ORC_VAR_D1);
    orc_program_append_2 (p, "mulf", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_C3,
        ORC_VAR_D1);
    orc_program_append_2 (p, "addf", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_C4,
        ORC_VAR_D1);
...
/* video_orc_unpack_RGBA_F32_swap */
#ifdef DISABLE_ORC
void
video_orc_unpack_RGBA_F32_swap (guint16 * ORC_RESTRICT d1,
    const gfloat * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union16 *ORC_RESTRICT ptr0;
  ...
  /* 6: loadpl */
  var36.i = 0x3f800000;         /* 1065353216 or 5.26354e-315f */
  /* 8: loadpl */
  var37.i = 0x477fff00;         /* 1199570688 or 5.92667e-315f */
  /* 10: loadpl */
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 7: minf */
    {
      ...
      if (ORC_ISNAN (_src1.i))
        ...
        var44.i = (_src1.f < _src2.f) ? _src1.i : _src2.i;
    }
    /* 9: mulf */
    {
      orc_union32 _src1;
    ...
    /* 12: convfl */
    {
      int tmp;
      tmp = (int) var46.f;
      if (tmp == 0x80000000 && !(var46.i & 0x80000000))
        tmp = 0x7fffffff;
      var47.i = tmp;
    }
    /* 13: convlw */
...
#else
static void
_backup_video_orc_unpack_RGBA_F32_swap (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union16 *ORC_RESTRICT ptr0;
...
#if 1
    static const orc_uint8 bc[] = {
      1, 9, 30, 118, 105, 100, 101, 111, 95, 111, 114, 99, 95, 117, 110, 112,
      97, 99, 107, 95, 82, 71, 66, 65, 95, 70, 51, 50, 95, 115, 119, 97,
      112, 11, 2, 2, 12, 4, 4, 14, 4, 0, 0, 0, 0, 14, 4, 0,
      0, 128, 63, 14, 4, 0, 255, 127, 71, 14, 4, 0, 0, 0, 63, 20,
      4, 20, 4, 184, 32, 4, 207, 33, 32, 32, 106, 32, 32, 33, 205, 32,
      32, 16, 206, 32, 32, 17, 202, 32, 32, 18, 200, 32, 32, 19, 210, 33,
      32, 163, 0, 33, 2, 0,
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_orc_unpack_RGBA_F32_swap);
#else
    p = orc_program_new ();
    orc_program_set_name (p, "video_orc_unpack_RGBA_F32_swap");
    orc_program_set_backup_function (p, _backup_video_orc_unpack_RGBA_F32_swap);
    orc_program_add_destination (p, 2, "d1");
    orc_program_add_source (p, 4, "s1");
    orc_program_add_constant (p, 4, 0x00000000, "c1");
...
/* video_orc_pack_RGBA_F32 */
#ifdef DISABLE_ORC
void
video_orc_pack_RGBA_F32 (gfloat * ORC_RESTRICT d1,
    const guint16 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
  ...
  /* 3: loadpl */
  var35.i = 0x37800080;         /* 931135616 or 4.60042e-315f */
...
#else
static void
_backup_video_orc_pack_RGBA_F32 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 *ORC_RESTRICT ptr0;
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  if (!orc_once_enter (&once, (void **) &c)) {
    ...
    static const orc_uint8 bc[] = {
      1, 9, 23, 118, 105, 100, 101, 111, 95, 111, 114, 99, 95, 112, 97, 99,
      107, 95, 82, 71, 66, 65, 95, 70, 51, 50, 11, 4, 4, 12, 2, 2,
      14, 4, 128, 0, 128, 55, 20, 4, 20, 4, 154, 32, 4, 211, 33, 32,
      202, 0, 33, 16, 2, 0,
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_orc_pack_RGBA_F32);
#else
    p = orc_program_new ();
    orc_program_set_name (p, "video_orc_pack_RGBA_F32");
    orc_program_set_backup_function (p, _backup_video_orc_pack_RGBA_F32);
    orc_program_add_destination (p, 4, "d1");
    orc_program_add_source (p, 2, "s1");
    orc_program_add_constant (p, 4, 0x37800080, "c1");
    orc_program_add_temporary (p, 4, "t1");
    orc_program_add_temporary (p, 4, "t2");

    orc_program_append_2 (p, "convuwl", 0, ORC_VAR_T1, ORC_VAR_S1, ORC_VAR_D1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "convlf", 0, ORC_VAR_T2, ORC_VAR_T1, ORC_VAR_D1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "mulf", 0, ORC_VAR_D1, ORC_VAR_T2, ORC_VAR_C1,
        ORC_VAR_D1);
#endif
...
/* video_orc_pack_RGBA_F32_swap */
#ifdef DISABLE_ORC
void
video_orc_pack_RGBA_F32_swap (gfloat * ORC_RESTRICT d1,
    const guint16 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_video_orc_pack_RGBA_F32_swap (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 *ORC_RESTRICT ptr0;
    ...
    const guint16 * ORC_RESTRICT s1, int n)
{
  ...
  if (!orc_once_enter (&once, (void **) &c)) {
...
#if 1
    static const orc_uint8 bc[] = {
      1, 9, 28, 118, 105, 100, 101, 111, 95, 111, 114, 99, 95, 112, 97, 99,
      107, 95, 82, 71, 66, 65, 95, 70, 51, 50, 95, 115, 119, 97, 112, 11,
      4, 4, 12, 2, 2, 14, 4, 128, 0, 128, 55, 20, 4, 20, 4, 154,
      32, 4, 211, 33, 32, 202, 33, 33, 16, 184, 0, 33, 2, 0,
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_video_orc_pack_RGBA_F32_swap);
#else
    p = orc_program_new ();
    orc_program_set_name (p, "video_orc_pack_RGBA_F32_swap");
    orc_program_set_backup_function (p, _backup_video_orc_pack_RGBA_F32_swap);
    orc_program_add_destination (p, 4, "d1");
    orc_program_add_source (p, 2, "s1");
    orc_program_add_constant (p, 4, 0x37800080, "c1");
    ...
    orc_program_append_2 (p, "convlf", 0, ORC_VAR_T2, ORC_VAR_T1, ORC_VAR_D1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "mulf", 0, ORC_VAR_T2, ORC_VAR_T2, ORC_VAR_C1,
        ORC_VAR_D1);
    orc_program_append_2 (p, "swapl", 0, ORC_VAR_D1, ORC_VAR_T2, ORC_VAR_D1,
        ORC_VAR_D1);
#endif
