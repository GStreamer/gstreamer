...
TYPE_FIND_REGISTER_START_WITH_DEFINE (jng, "image/x-jng",
    ...
    GST_TYPE_FIND_MAXIMUM);
TYPE_FIND_REGISTER_START_WITH_DEFINE (xbm, "image/x-xbitmap",
    GST_RANK_SECONDARY, "xbm", "/* XBM */", 9, GST_TYPE_FIND_MAXIMUM);
...
/* image-rs typefinders */
TYPE_FIND_REGISTER_START_WITH_DEFINE (farbfeld, "image/x-farbfeld",
    GST_RANK_SECONDARY, "ff", "farbfeld", 8, GST_TYPE_FIND_NEARLY_CERTAIN);
TYPE_FIND_REGISTER_START_WITH_DEFINE (qoi, "image/qoi",
    GST_RANK_SECONDARY, "qoi", "qoif", 4, GST_TYPE_FIND_NEARLY_CERTAIN);
TYPE_FIND_REGISTER_START_WITH_DEFINE (dds, "image/vnd.ms-dds",
    GST_RANK_SECONDARY, "dds", "DDS ", 4, GST_TYPE_FIND_NEARLY_CERTAIN);
