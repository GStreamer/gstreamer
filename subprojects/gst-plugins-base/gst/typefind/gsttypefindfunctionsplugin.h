...
GST_TYPE_FIND_REGISTER_DECLARE (xbm);
...
GST_TYPE_FIND_REGISTER_DECLARE (ac4);
...
GST_TYPE_FIND_REGISTER_DECLARE (farbfeld);
GST_TYPE_FIND_REGISTER_DECLARE (qoi);
GST_TYPE_FIND_REGISTER_DECLARE (dds);
GST_TYPE_FIND_REGISTER_DECLARE (radiance);
