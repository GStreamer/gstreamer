...
static void ges_track_title_src_get_property (GObject * object,
    guint property_id, GValue * value, GParamSpec * pspec);

static void ges_track_title_src_dispose (GObject *);

static void ges_track_title_src_finalize (GObject *);

static void ges_track_title_src_set_property (GObject * object,
    guint property_id, const GValue * value, GParamSpec * pspec);

static gboolean ges_track_title_src_create_gnl_object (GESTrackObject * object);

static GstElement
    * ges_track_title_src_create_element_func (GESTrackTitleSource * object);
...
ges_track_title_src_class_init (GESTrackTitleSourceClass * klass)
{
  ...
  track_class->create_gnl_object = ges_track_title_src_create_gnl_object;
  klass->create_element = ges_track_title_src_create_element_func;
}
...
static void
ges_track_title_src_get_property (GObject * object, guint property_id,
...
static void
ges_track_title_src_set_property (GObject * object, guint property_id,
...
static gboolean
ges_track_title_src_create_gnl_object (GESTrackObject * object)
{
  GESTrackTitleSourceClass *klass;
  GESTrackTitleSource *self;

  self = GES_TRACK_TITLE_SOURCE (object);
  klass = GES_TRACK_TITLE_SOURCE_GET_CLASS (object);

  object->gnlobject = gst_element_factory_make ("gnlsource", NULL);
  self->element = klass->create_element (GES_TRACK_TITLE_SOURCE (object));
...
static GstElement *
ges_track_title_src_create_element_func (GESTrackTitleSource * self)
{
